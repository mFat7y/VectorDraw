...
public class Square implements Shape{
	...
	public void draw(Graphics canvas) {
		...
		canvas.fillRect(myPos.x, myPos.y, myProp.get("Length").intValue(), myProp.get("Length").intValue());
		canvas.setColor(myColor);
		canvas.drawRect(myPos.x, myPos.y, myProp.get("Length").intValue(), myProp.get("length").intValue());
	}
